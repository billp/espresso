...
> If the install fails due to a stale CDN cache, pin to the latest commit SHA:
> ```bash
> curl -fsSL https://raw.githubusercontent.com/billp/espresso/d915633/install.sh | bash
> ```
